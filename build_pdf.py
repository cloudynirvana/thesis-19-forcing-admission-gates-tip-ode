...
<head>
<meta charset="utf-8"/>
<title>Thesis #19. Forcing admission under evidence gates</title>
<style>
@page {{
  size: A4;
  margin: 22mm 18mm 24mm 18mm;
  @bottom-center {{
    content: "Ogbonna KE. Thesis #19. Computational research only. Not a medical device. " counter(page);
    font-size: 8.5pt;
    color: #444;
